...
[![Mind map rendered by mindmaply-core from the outline above](./docs/example.svg)](https://mindmaply.app/#/editor?d=)

The image above is `docs/example.svg`, generated by `mindmaply-core` itself — click it to open the same document in the live editor.
