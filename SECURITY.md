...
Email **gaurav@imaginedigital.com** with a description and reproduction steps, or use GitHub's [private vulnerability reporting](https://github.com/productscalexyz/mindmaply/security/advisories/new) if enabled.
